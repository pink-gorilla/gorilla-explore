(ns pinkgorilla.explorer.handler
  (:require
   ...
   [pinkgorilla.explore.handler :refer [handler-explore-async  handler-my-github-notebooks]]))

(add-ring-handler :api/my-github (wrap-api-handler handler-my-github-notebooks))
